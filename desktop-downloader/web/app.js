(() => {
  ...
  const words = {
    en: {
      ...
      rekordboxTagsHelp: "Rekordbox reads Genre, Grouping, and Comments from the audio file on import. Playlist name is written to Grouping (and Comments). Rekordbox My Tags and colour labels live only inside Rekordbox and cannot be set from this app.",
    ...
    it: {
      ...
      rekordboxTagsHelp: "Rekordbox legge Genere, Raggruppamento e Commenti dal file all’importazione. Il nome playlist viene scritto in Raggruppamento (e nei Commenti). I My Tag e i colori di Rekordbox restano solo nel database Rekordbox e non si possono impostare da questa app.",
